...
class Route extends AbstractRestController {
    ...
    private function searchRouteESI(int $systemFromId, int $systemToId, int $searchDepth = 0, array $mapIds = [], array $filterData = []) : array {
		...
		'avoid' => [ 30000021, 30000157, 30000192, 30000206, 30001372, 30001381, 30001413, 30001445, 30002079, 30002225, 30002411, 30002652, 30002702, 30002737, 30002770, 30002797, 30003046, 30003495, 30003504, 30005005, 30005029, 30010141, 30020141, 30031392, 30040141, 30045328, 30045329 ]
            ];
